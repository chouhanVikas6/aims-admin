        ...
        <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
            <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
                <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
                    ...
                    <span className="lg:hidden text-xl font-bold text-brand-500">
                        AIMS Admin
                    </span>
                ...
                <div className="hidden lg:flex items-center gap-4 px-5 py-4 lg:px-0">
                    {/* User info */}
                    {user && (
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-3 py-2 text-sm text-gray-600 rounded-lg hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 transition-colors"
                        aria-label="Logout"
                    >
                        <LogoutIcon />
                ...
                <div className="flex lg:hidden items-center gap-3 px-3 py-2 w-full border-b border-gray-200 dark:border-gray-800">
                    {user && (
